...
export default function example() {
    ...
    const material3 = new THREE.MeshStandardMaterial({ color: '#1c9' });
    ...
    gui.add(light.position, 'x', -5, 5).name('X');
    gui.add(light.position, 'y', -5, 5).name('Y');
    gui.add(light.position, 'z', -5, 5).name('Z');
